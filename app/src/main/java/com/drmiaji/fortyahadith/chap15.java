...
public class chap15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chap15);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent right = new Intent(chap15.this, chap14.class);
                startActivity(right);
            }
        });
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent right = new Intent(chap15.this, chap16.class);
                startActivity(right);
            }
        });

        TextView textView = findViewById(R.id.chap15);
        textView.setText(readTxt());
    }

    private String readTxt() {
        InputStream inputStream = getResources().openRawResource(R.raw.chap15);
