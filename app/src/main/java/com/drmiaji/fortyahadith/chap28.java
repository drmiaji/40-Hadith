...
public class chap28 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.chap28);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent right = new Intent(chap28.this, chap27.class);
                startActivity(right);
            }
        });
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent right = new Intent(chap28.this, chap29.class);
                startActivity(right);
            }
        });

        TextView textView = findViewById(R.id.chap28);
        textView.setText(readTxt());
    }

    private String readTxt() {
        InputStream inputStream = getResources().openRawResource(R.raw.chap28);
