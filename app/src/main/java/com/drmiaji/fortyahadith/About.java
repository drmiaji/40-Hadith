...
public class About extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeface = Typeface.createFromAsset(getAssets(), "fonts/solaimanlipi.ttf");
        customFont = findViewById(R.id.rateUs);
        customFont.setTypeface(typeface);

        TextView textView = findViewById(R.id.action_about_us);
    ...
    public void goToChap(View view) {
        if (view.getId() == R.id.rateUs) {
            ...
            intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.drmiaji.ekram"));
